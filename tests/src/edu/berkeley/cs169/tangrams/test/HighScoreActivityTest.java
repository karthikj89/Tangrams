...
import edu.berkeley.cs169.tangrams.HighScoreActivity;
...
public class HighScoreActivityTest extends ActivityInstrumentationTestCase2<HighScoreActivity> {
	...
	public HighScoreActivityTest() {
		super("edu.berkeley.cs169.tangrams", HighScoreActivity.class);
	}
    ...
    protected void setUp() throws Exception {
        ...
        hs = (LinearLayout) mActivity.findViewById(edu.berkeley.cs169.tangrams.R.id.HighScore);
    }
